// src/types/index.ts — VERSÃO FINAL 2025 (com Processual Civil adicionado)
export type {
...
// PROCESSUAL CIVIL — ADICIONADO AQUI (FINAL)
export type {
  ProcessualCivilInput,
  IProcessualCivilResponse,
